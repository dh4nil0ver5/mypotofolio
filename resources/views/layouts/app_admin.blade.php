...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/plusadmin/assets/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="{{ URL::to('/') }}/plusadmin/assets/vendors/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" href="{{ URL::to('/') }}/plusadmin/assets/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/plusadmin/assets/vendors/jquery-bar-rating/css-stars.css" />
    <link rel="stylesheet" href="{{ URL::to('/') }}/plusadmin/assets/vendors/font-awesome/css/font-awesome.min.css" />
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/plusadmin/assets/css/demo_2/style.css" />
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ URL::to('/') }}/plusadmin/assets/images/favicon.png" />
  </head>
  <body>
          ...
          <div class="container">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <a class="navbar-brand brand-logo" href="index.html">
                <img src="{{ URL::to('/') }}/plusadmin/assets/images/logo.svg" alt="logo" />
                <span class="font-12 d-block font-weight-light">Responsive Dashboard </span>
              </a>
              <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ URL::to('/') }}/plusadmin/assets/images/logo-mini.svg" alt="logo" /></a>
            </div>
                ...
                <li class="nav-item nav-profile dropdown">
                  <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="nav-profile-img">
                      <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face1.jpg" alt="image" />
                    </div>
          ...
          <div class="content-wrapper pb-0">
            ...
            <div class="row">
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid w-100" src="{{ URL::to('/') }}/plusadmin/assets/images/dashboard/img_1.jpg" alt="" />
                  </div>
              ...
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid w-100" src="{{ URL::to('/') }}/plusadmin/assets/images/dashboard/img_2.jpg" alt="" />
                  </div>
                  <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                      <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
              ...
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid" src="{{ URL::to('/') }}/plusadmin/assets/images/dashboard/img_3.jpg" alt="" />
                  </div>
                  <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                      <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
                    ...
                    <div class="table-responsive">
                      <table class="table custom-table text-dark">
                        ...
                        <tbody>
                          <tr>
                            <td>
                             <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face2.jpg" class="me-2" alt="image" /> Jacob Jensen 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face3.jpg" class="me-2" alt="image" /> Cecelia Bradley 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face4.jpg" class="me-2" alt="image" /> Leah Sherman 
                            </td> 
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face5.jpg" class="me-2" alt="image" /> Ina Curry 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face7.jpg" class="me-2" alt="image" /> Lida Fitzgerald 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face2.jpg" class="me-2" alt="image" /> Stella Johnson 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{ URL::to('/') }}/plusadmin/assets/images/faces/face9.jpg" class="me-2" alt="image" /> Maria Ortiz 
                            </td>
                            <td>
                              <div class="d-flex">
                                <span class="pe-2 d-flex align-items-center">65%</span>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
                <div class="card color-card-wrapper">
                  <div class="card-body">
                    <img class="img-fluid card-top-img w-100" src="{{ URL::to('/') }}/plusadmin/assets/images/dashboard/img_5.jpg" alt="" />
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/jquery-bar-rating/jquery.barrating.min.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/chart.js/Chart.min.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/flot/jquery.flot.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/flot/jquery.flot.resize.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/flot/jquery.flot.categories.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/flot/jquery.flot.fillbetween.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/vendors/flot/jquery.flot.stack.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/js/jquery.cookie.js" type="text/javascript"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="{{ URL::to('/') }}/plusadmin/assets/js/off-canvas.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/js/hoverable-collapse.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/js/misc.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/js/settings.js"></script>
    <script src="{{ URL::to('/') }}/plusadmin/assets/js/todolist.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="{{ URL::to('/') }}/plusadmin/assets/js/dashboard.js"></script>
